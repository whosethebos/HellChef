...
public class Tacos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        myRef.child("liked").addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(Tacos.this,"Something went wrong",Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void saved(View view) {
        if(tacos_count==1)
        {
            ...
            Toast.makeText(Tacos.this,"Removed from Liked Recipes",Toast.LENGTH_SHORT).show();
        }
        else
        {
            ...
            Toast.makeText(Tacos.this,"Added to Liked Recipes",Toast.LENGTH_SHORT).show();
        }
    }
